...
add_action('mpu_insert_script_hook', function () {
...
add_action('wp_loaded', function () {
  ...
  add_action('wp_footer', function() { do_action('mpu_insert_script_hook'); }, -1000000);
  add_action('wp_head', function() { do_action('mpu_insert_script_hook'); }, 1000000);
  add_action('wp_print_scripts', function() { do_action('mpu_insert_script_hook'); }, 1000000);
  add_action('wp_print_styles', function() { do_action('mpu_insert_script_hook'); }, 1000000);
